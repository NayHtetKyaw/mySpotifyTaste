import { Card, Text, Flex, Stack, Divider, Select } from "@mantine/core";
    ...
    return (
        <Flex p="lg" justify="center" wrap="wrap">
            ...
            >
                ...
                <Stack w="full" align="stretch" justify="flex-start" gap="md">
                ...
                <Text
                    color="green"
                    m="sm"
                    className="relative top-2 text-center"
                >
                    SEE MORE
                </Text>
            </Card>
            ...
            >
                ...
                <Stack w="full" align="stretch" justify="flex-start" gap="sm">
